'''
初始版本:环境的基本单元：episode_Data
当交易从episode_data开始到episode结束，也就是day==episode_window，进入终止状态

王师兄代码：训练数据划分为连续的episode，环境就定义一次，但是终止状态为profit_
...
class TradingEnv(gym.Env):
    ...
    def __init__(self, df, obs_dim=23, day=0, episode_window=480):
    ...
    def step(self, action):
        ...
        trade_action = action
        pre_action = 0 if self.day == 0 else self.action_memory[self.day - 1]
